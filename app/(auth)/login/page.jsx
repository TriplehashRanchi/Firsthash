            ...
            <div className="w-full max-w-md space-y-6">
                ...
                {!forgotOpen ? (
                    <>
                        ...
                        <p onClick={() => setForgotOpen(true)} className="text-sm text-blue-600 hover:underline cursor-pointer text-right">
                            Forgot Password?
                        </p>

                        <button onClick={handleEmailLogin} disabled={loading} className="w-full bg-black text-white py-3 rounded font-semibold">
                            {loading ? 'Logging in...' : 'Login with Email'}
                        </button>

                        <button onClick={handleGoogleLogin} disabled={loading} className="w-full bg-gray-100 text-black py-3 rounded font-semibold flex items-center justify-center space-x-2">
  ...
  <span>Login with Phone</span>
                    ...
                    <form onSubmit={handlePasswordReset} className="space-y-4">
                        ...
                        <div className="flex justify-between">
                            <button type="button" onClick={() => setForgotOpen(false)} className="px-3 py-2 border rounded">
                                Back to Login
                            </button>
