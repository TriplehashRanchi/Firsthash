...
export default function EnhancedFormBuilder() {
    ...
    const admin_id = user?.uid; // Use optional chaining and consistent naming
    ...
    const availableAdditionalFields = [
        ...
        { label: 'Date', name: 'date', type: 'date', icon: <HiCalendar className="w-5 h-5 text-gray-500" /> },
        { label: 'Gender', name: 'gender', type: 'select', options: ['Male', 'Female', 'Other'], icon: <HiOutlineUserGroup className="w-5 h-5 text-gray-500" /> },
        { label: 'Event Type', name: 'company_name', type: 'text', icon: <HiOutlineBriefcase className="w-5 h-5 text-gray-500" /> },
        { label: 'Event Location', name: 'event_location', type: 'text', icon: <HiOutlineDocumentText className="w-5 h-5 text-gray-500" /> },
        { label: 'Event Month', name: 'event_month', type: 'date', icon: <HiOutlineClipboardCheck className="w-5 h-5 text-gray-500" /> },
        { label: 'Amount', name: 'coverage_amount', type: 'number', icon: <HiOutlineCurrencyDollar className="w-5 h-5 text-gray-500" /> },
    ...
    const generateEmbedCode = () => {
        ...
        const formId = 'fisrthashEmbedForm'; // Unique ID
        const statusId = 'firsthashEmbedStatus'; // Unique ID
