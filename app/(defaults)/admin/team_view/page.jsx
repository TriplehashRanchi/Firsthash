...
const IconEdit = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-gray-500 hover:text-green-600">
        <path
            strokeLinecap="round"
            strokeLinejoin="round"
...
const IconCalendar = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-gray-500 hover:text-indigo-600">
        <path
            strokeLinecap="round"
            strokeLinejoin="round"
                ...
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">
                            For {memberName} on {new Date(record.a_date).toLocaleDateString()}
                        </p>
                    </div>
                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 transition-opacity ${record.a_status === 1 ? 'opacity-100' : 'opacity-50'}`}>
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => onRecordChange('in_time', e.target.value)}
                                disabled={record.a_status !== 1}
                                className="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 disabled:bg-gray-100"
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => onRecordChange('out_time', e.target.value)}
                                disabled={record.a_status !== 1}
                                className="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 disabled:bg-gray-100"
                            />
                        </div>
