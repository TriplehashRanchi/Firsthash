...
export const importTaskBundleToDeliverable2 = async (projectId, body) =>
  request(`/api/projects/${projectId}/deliverables-2/import-task-bundle`, {
    method: 'POST',
    body: JSON.stringify(body),
  });

export const updateDeliverable2DueDate = async (deliverable2Id, body) =>
  request(`/api/projects/deliverables-2/${deliverable2Id}/due-date`, {
    method: 'PUT',
    body: JSON.stringify(body),
  });

export const deleteAllDeliverables2 = async (projectId) =>
  request(`/api/deliverables/${projectId}/deliverables-2`, {
    method: 'DELETE',
  });