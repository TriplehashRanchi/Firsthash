                ...
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <img className="ml-[5px] w-40 flex-none" src="/assets/images/logo.png" alt="logo" />
                            {/* <span className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">IPCStudios</span> */}
                        </Link>
                                     ...
                                     <li className="menu nav-item">
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'customer_tab' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                 <li>
                                                    <Link href="/manager/enquiry">{t('Enquiry')}</Link>
                                                </li>
